...
class EmailVerify(View):
    ...
    def get(self, request, uidb64, token):
        """Метод для проверки токена пользователя, если он прошел проверку наличия в БД с помощью функции "get_user".
    ...
    @staticmethod
    def get_user(uidb):
        """Метод для обработки "uid" из ссылки и возврат пользователя, если он есть в БД, либо ничего,
